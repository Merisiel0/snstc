...
PhysicalDeviceQueueFamilyIndexes PhysicalDevice::findQueueFamilyIndexes(
  ...
  if(queueFamilyIndexes.graphicsFamilyIndex.has_value()) {
    for(uint32_t i = 0; i < queueFamilyPropertyCount; i++) {
      if(i != queueFamilyIndexes.graphicsFamilyIndex &&
...
int PhysicalDevice::rate(VkPhysicalDevice physicalDevice,
